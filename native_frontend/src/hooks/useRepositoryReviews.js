...
const useRepositoryReviews = (id, first) => {
  ...
  const { loading, data, refetch, error, fetchMore } = useQuery(GET_REPOSITORY_REVIEWS, {
    variables,
  ...
  return { repository: data?.repository, loading, refetch, error, fetchMore: handleFetchMore };
};
